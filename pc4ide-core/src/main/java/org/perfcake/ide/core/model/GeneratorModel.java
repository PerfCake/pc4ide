...
public class GeneratorModel extends AbstractModel implements PropertyContainer {
    ...
    public static final String PROPERTY_CLASS = "generator-class";
    public static final String PROPERTY_THREADS = "generator-threads";
    public static final String PROPERTY_RUN = "generator-run";
    public static final  String PROPERTY_PROPERTY = "generator-property";
    ...
    /**
     * Sets number of threads for the generator.
    ...
    /**
     * Sets implementation class of the generator.
     * @param value fully qualified name of generator implementation.
     */
