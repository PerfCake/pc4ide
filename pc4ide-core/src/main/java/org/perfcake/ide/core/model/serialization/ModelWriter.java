...
/**
 * Model writer is able to flush pc4ide scenario model to output stream.
 * @author Jakub Knetl
 */
public interface ModelWriter {
     ...
     */
    void writeScenario(ScenarioModel scenarioModel, OutputStream outputStream) throws ModelConversionException,
