...
/**
 * Represents exception during serilization or deserialization.
 *
 * @author Jakub Knetl
 */
public class ModelSerializationException extends Exception {
    ...
    public ModelSerializationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
