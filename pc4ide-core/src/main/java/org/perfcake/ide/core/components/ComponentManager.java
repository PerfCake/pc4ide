...
public class ComponentManager {
     ...
     * @param propertiesInput Documentation of components and their properties
    ...
    /**
     * Gets map of component implementations for component kinds.
     *
    ...
    /**
     * Gets map between component kinds and Component interface or class.
     *
    ...
    /**
     * Gets component interface or class based on kind.
     *
    ...
    /**
     * Gets component implementations based on kind.
     *
     ...
     * @param component component whose field should be returned
     ...
     *
     * @param component component whose field's documentation should be returned
