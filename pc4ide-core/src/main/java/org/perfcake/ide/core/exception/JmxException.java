...
/**
 * Represents exception in communication with jmx.
 *
 * @author Jakub Knetl
 */
public class JmxException extends Exception {
    ...
    protected JmxException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
