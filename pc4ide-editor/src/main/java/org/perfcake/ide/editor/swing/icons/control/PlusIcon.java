...
public class PlusIcon extends AbstractControlIcon {
    ...
    private void paint(Graphics2D g) {
        ...
        ((GeneralPath) shape).moveTo(3.0, 0.0);
        ((GeneralPath) shape).lineTo(3.0, 3.0);
        ((GeneralPath) shape).lineTo(0.0, 3.0);
        ((GeneralPath) shape).lineTo(0.0, 5.0);
        ((GeneralPath) shape).lineTo(3.0, 5.0);
        ((GeneralPath) shape).lineTo(3.0, 8.0);
        ((GeneralPath) shape).lineTo(5.0, 8.0);
        ((GeneralPath) shape).lineTo(5.0, 5.0);
        ((GeneralPath) shape).lineTo(8.0, 5.0);
        ((GeneralPath) shape).lineTo(8.0, 3.0);
        ((GeneralPath) shape).lineTo(5.0, 3.0);
        ((GeneralPath) shape).lineTo(5.0, 0.0);
        ((GeneralPath) shape).lineTo(3.0, 0.0);
