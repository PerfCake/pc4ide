 ...
 * @author Jakub Knetl
 */
public class CorrelatorController extends AbstractController {
     ...
     */
    public CorrelatorController(Model model, ModelFactory modelFactory, ViewFactory viewFactory) {
    ...
    public boolean updateViewData() {
        CorrelatorView view = (CorrelatorView) this.view;

        boolean modified = false; // was view modified during execution of this method?

        Value implementation = model.getSingleProperty(CorrelatorModel.PropertyNames.IMPLEMENTATION.toString(), Value.class);
