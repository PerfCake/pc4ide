...
public class CircularSector extends JPanel {
    ...
    /**
     * Creates new circular sector.
     * @param componentName Name of the sector
     * @param center center point
     * @param outerRadius outer radius of the sector
     * @param innerRadius inner radius of the sector
     * @param startAngle under what angle should sector start
     * @param angleExtent how large angle the sector uses.
     */
    ...
    /**
     * Draw the sector using graphics context.
